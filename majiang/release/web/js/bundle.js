...
(() => {
  ...
  var HallRTBase = class extends Laya.Scene {
  };
  ...
  HallRT = __decorateClass([
    regClass("ILv1KzqpSC2cya7sKOGPxw")
  ], HallRT);
  ...
  MainRT = __decorateClass([
    regClass3("yw52ApOlQMmtk1rLzO8R8A")
  ], MainRT);
  ...
  HandleReceivedMessage = __decorateClass([
    regClass4("tl_KYSgYS7CmOHmtD_4LCQ")
  ...
  var _a2;
  var SocketHelper = class _SocketHelper {
    // 当前重连次数
    constructor(url) {
      this.websocket = null;
  ...
  HallScript = __decorateClass([
    regClass5("oUus1KxUTcS1l8g_LTBkpA")
  ], HallScript);
  ...
  Script = __decorateClass([
    regClass6("iM6oxkqBQtumEAAx4347yw")
  ], Script);
})();
